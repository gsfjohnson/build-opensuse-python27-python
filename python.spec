...
# Patch54: doesn't apply to rhel < 7
...
# Patch159: Doesn't apply to rhel < 7
...
# 00182 #
# Upstream as of Python 2.7.7
#  Patch182: python-2.7.5-memory-leak-marshalc.patch
...
# UPDATE: SSL3 was again enabled in openssl so I am disabling this patch
# UPDATE: If you will later try to re-enable it again please see rhbz#1156519
